...
网页交互当前使用已验证的 `pets/deepseek-lowpoly.glb`。`pets/deepseek-high-detail.blend` 是使用 Blender 4.5 LTS 根据正面、侧面、背面参考图生成的可编辑高细节工程，含网格、材质、基础骨骼、灯光、相机和内嵌参考图；对应导出文件是 `pets/deepseek-high-detail.glb`。高细节版本仍在 refining，不宣称已经达到商业动画级精模标准，当前页面也不加载它。
